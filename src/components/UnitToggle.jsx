  ...
  return (
    ...
    >
      ...
      <span className="relative flex items-center gap-2">
        ...
        <span className="font-semibold">{isCelsius ? "°C" : "°F"}</span>
