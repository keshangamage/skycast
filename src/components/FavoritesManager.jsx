                  ...
                  {favorites.map((favorite) => (
                    ...
                    >
                      <button
                        ...
                        disabled={loading}
                        className="flex-1 text-left text-white hover:text-white/90 transition-colors disabled:opacity-60"
                      >
                        {favorite.displayName}
                      </button>
                      <button
                        onClick={() => removeFromFavorites(favorite.id)}
                        className="text-red-400 hover:text-red-300 transition-colors opacity-0 group-hover/item:opacity-100"
    ...
    AddToFavoritesButton: ({ cityName, country }) => {
      ...
      return (
        <button
          ...
          className={`inline-flex items-center gap-2 px-3 py-2 rounded-xl backdrop-blur-sm border transition-all duration-300 ${
            isFav
